        ...
        foreach($productos as $producto){
            ...
            $data["label"] = '
                                <div class = "d-flex ml-4 flex-column">
                                    <span class="text-sm"><b>Codigo: </b> ' .$codigo_producto. ' - <b>Producto: </b> '.$descripcion_producto. '</span>
                                    <span class="text-sm"><b>Precio: </b> S/.' .round($precio_venta_producto,2). ' - <b>Categoria:</b> '.$nombre_categoria. '</span>
                                    <span class="text-sm"> ' . ' <b>Stock:</b> '.$stock_producto. '</span>
                                </div>
                            </a>';
